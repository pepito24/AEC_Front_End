...
export class AjouterObjet extends React.Component {
  constructor(props) {
    super(props);
    ...
    this.addObjet = this.addObjet.bind(this);
  }

  async addObjet(nom,photo,attaque1, attaque2) { 
    try{ 
  ...
  handleAdd(event){
    ...
    this.addObjet(nom,photo,attaque1,attaque2);
  }
